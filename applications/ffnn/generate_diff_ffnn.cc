...
const int32_t FFNN_UNIFORM_DATA = 2;
const int32_t FFNN_UNIFORM_WEIGHTS = 3;
const int32_t FFNN_UNIFORM_SPARSE = 4;
const int32_t FFNN_DIFFERENCE = 5;
...
int main(int argc, char **argv) {
  ...
  funs.push_back(abstract_ud_spec_t{.id = FFNN_DIFFERENCE,
